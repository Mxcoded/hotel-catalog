                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text"><strong>Price:</strong> &#8358;{{ number_format($room->price, 2, '.', ',') }} / Night</p>
                                ...
                                <small class="text-muted status-text">
                                    @if (!$room->available)
                                        <span class="status-unavailable">
                                            Not available until {{ \Carbon\Carbon::parse($room->available_from)->format('D M, Y') }}
                                            ({{ \Carbon\Carbon::now()->startOfDay()->diffInDays(\Carbon\Carbon::parse($room->available_from)->startOfDay()) }} days left)
                                        </span>
                                    @else
    ...
    document.addEventListener("DOMContentLoaded", function() {
        document.querySelectorAll(".read-more-link").forEach(link => {
            ...
            link.addEventListener("click", function() {
                ...
                hiddenFeatures.forEach(feature => feature.classList.toggle("d-none", !isExpanded));
